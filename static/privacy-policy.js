  ...
  return (
    <Layout>
      <div className="py-3 px-4">
        ...
        <p>
          <b>The Muhymin Blog</b> operates
          <b> https://muhymin.com/</b> (hereinafter referred to as{" "}
          <b>“Service”</b>
          ).
        </p>
        <p>
          Our Privacy Policy governs your visit to <b>https://muhymin.com/</b>,
        ...
        <p>
          <b>SERVICE</b> means the https://muhymin.com/ website operated by The
          Muhymin Blog.
        </p>
        <p>
        ...
        <p>
          1. <b>Session Cookies:</b> We use Session Cookies to operate our
          Service.
        </p>
        <p>
          2. <b>Preference Cookies:</b> We use Preference Cookies to remember
          your preferences and various settings.
        </p>
        <p>
          3. <b>Security Cookies:</b> We use Security Cookies for security
          purposes.
        </p>
        <p>
          4. <b>Advertising Cookies:</b> Advertising Cookies are used to serve
        ...
        <p>The Muhymin Blog uses the collected data for various purposes:</p>
        ...
        <p>
          5.5. to gather analysis or valuable information so that we can improve
          our Service;
        </p>
        ...
        <p>
          5.9. to carry out our obligations and enforce our rights arising from
        ...
        <p>
          5.11. to provide you with news, special offers and general information
        ...
        <p>
          The Muhymin Blog will take all the steps reasonably necessary to
        ...
        <p>
          8.1. <b>Disclosure for Law Enforcement.</b>
        </p>
        <p>
        ...
        <p>
          8.3. <b>Other cases. We may disclose your information also:</b>
        </p>
        <p>8.3.1. to our subsidiaries and affiliates;</p>
        <p>
          8.3.2. to contractors, service providers, and other third parties we
        ...
        <p>
          8.3.7. if we believe disclosure is necessary or appropriate to protect
        ...
        <p>
          10.1. the right to access, update or to delete the information we have
          on you;
        </p>
        <p>
          10.2. the right of rectification. You have the right to have your
        ...
        <p>
          10.4. the right of restriction. You have the right to request that we
          restrict the processing of your personal information;
        </p>
        <p>
          10.5. the right to data portability. You have the right to be provided
          with a copy of your Personal Data in a structured, machine-readable
          and commonly used format;
        </p>
        <p>
          10.6. the right to withdraw consent. You also have the right to
        ...
        <p>
          11.2. our Privacy Policy link includes the word “Privacy”, and can
          easily be found on the home page of our website;
        </p>
        <p>
          11.3. users will be notified of any privacy policy changes on our
          Privacy Policy Page;
        </p>
        <p>
          11.4. users are able to change their personal information by emailing
          us at <b>rafid@muhymin.com</b>.
        </p>
        ...
        <p>
          <b>
            12.1. What personal information we have about you. If you make this
            request, we will return to you:
          </b>
        </p>
        <p>
          12.1.1. The categories of personal information we have collected about
          you.
        </p>
        <p>
          12.1.2. The categories of sources from which we collect your personal
          information.
        </p>
        <p>
          12.1.3. The business or commercial purpose for collecting or selling
          your personal information.
        </p>
        <p>
          12.1.4. The categories of third parties with whom we share personal
          information.
        </p>
        <p>
          12.1.5. The specific pieces of personal information we have collected
          about you.
        </p>
        <p>
          12.1.6. A list of categories of personal information that we have
          sold, along with the category of any other company we sold it to. If
          we have not sold your personal information, we will inform you of that
          fact.
        </p>
        <p>
          12.1.7. A list of categories of personal information that we have
        ...
        <p>
          <b>
            12.2. To delete your personal information. If you make this request,
        ...
        <p>
          <b>
            12.3. To stop selling your personal information. We don’t sell or
        ...
        <p>
          ...
          please send your request(s) by email: <b>rafid@muhymin.com</b>.
        </p>
        <p>
