  ...
  return (
    <Layout>
      <div className="py-3 px-4">
        ...
        <p>Last updated: 2020-05-15</p>
        <p>
          1. <b>Introduction</b>
        </p>
        <p>
          Welcome to <b>The Muhymin Blog!</b>
        </p>
        <p>
          These Terms of Service govern your use of our website located at
          <b> https://muhymin.com/</b> operated by <b>The Muhymin Blog</b>.
        </p>
        <p>
        ...
        <p>
          ...
          <b> rafid@muhymin.com</b> so we can try to find a solution. These
        ...
        <p>
          ...
          Service, you may be asked to supply certain information relevant to
          your Purchase including but not limited to, your credit or debit card
          number, the expiration date of your card, your billing address, and
        ...
        <p>
          The Muhymin Blog has the right but not the obligation to monitor and
          edit all Content provided by users.
        </p>
        <p>
          In addition, Content found on or through this Service are the property
          of The Muhymin Blog or used with permission. You may not distribute,
        ...
        <p>
          7.1.1. In any way that violates any applicable national or
        ...
        <p>
          7.1.3. To transmit, or procure the sending of, any advertising or
          promotional material, including any “junk mail”, “chain letter,”
          “spam,” or any other similar solicitation.
        </p>
        <p>
          7.1.4. To impersonate or attempt to impersonate Company, a Company
          employee, another user, or any other person or entity.
        </p>
        <p>
          7.1.5. In any way that infringes upon the rights of others, or in any
        ...
        <p>
          7.1.6. To engage in any other conduct that restricts or inhibits
        ...
        <p>
          7.2.1. Use Service in any manner that could disable, overburden,
        ...
        <p>
          7.2.2. Use any robot, spider, or other automatic device, process, or
          means to access Service for any purpose, including monitoring or
          copying any of the material on Service.
        </p>
        <p>
          7.2.3. Use any manual process to monitor or copy any of the material
          on Service or for any other unauthorized purpose without our prior
          written consent.
        </p>
        <p>
          7.2.4. Use any device, software, or routine that interferes with the
          proper working of Service.
        </p>
        <p>
          7.2.5. Introduce any viruses, trojan horses, worms, logic bombs, or
          other material which is malicious or technologically harmful.
        </p>
        <p>
          7.2.6. Attempt to gain unauthorized access to, interfere with, damage,
        ...
        <p>
          7.2.7. Attack Service via a denial-of-service attack or a distributed
          denial-of-service attack.
        </p>
        <p>7.2.8. Take any action that may damage or falsify Company rating.</p>
        <p>
          7.2.9. Otherwise attempt to interfere with the proper working of
          Service.
        </p>
        <p>
          8. <b>Analytics</b>
        ...
        <p>
          ...
          property of The Muhymin Blog and its licensors. Service is protected
          ...
          without the prior written consent of The Muhymin Blog.
        </p>
        <p>
        ...
        <p>
          ...
          to rafid@muhymin.com, with the subject line: “Copyright Infringement”
        ...
        <p>
          11.1. an electronic or physical signature of the person authorized to
          act on behalf of the owner of the copyright’s interest;
        </p>
        <p>
          11.2. a description of the copyrighted work that you claim has been
        ...
        <p>
          11.3. identification of the URL or other specific location on Service
          where the material that you claim is infringing is located;
        </p>
        <p>11.4. your address, telephone number, and email address;</p>
        <p>
          11.5. a statement by you that you have a good faith belief that the
          disputed use is not authorized by the copyright owner, its agent, or
          the law;
        </p>
        <p>
          11.6. a statement by you, made under penalty of perjury, that the
        ...
        <p>
          You can contact our Copyright Agent via email at rafid@muhymin.com.
        </p>
        <p>
          12. <b>Error Reporting and Feedback</b>
        </p>
        <p>
          You may provide us either directly at rafid@muhymin.com or via third
        ...
        <p>
          ...
          that are not owned or controlled by The Muhymin Blog.
        </p>
        <p>
          The Muhymin Blog has no control over, and assumes no responsibility
        ...
        <p>
          ...
          laws of Bangladesh, which governing law applies to agreement without
        ...
        <small className="d-block text-center mb-3">
          ...
          were created for <b>https://muhymin.com/</b> by
          <a href="https://policymaker.io"> PolicyMaker.io</a> on 2020-05-15.
        </small>
      </div>
    </Layout>
  );
